...
data = cv2.VideoCapture("../videos/motorbikes-1.mp4")
...
while True:
    ...
    for o in output:
        ...
        for box in boxes:
            ...
            cvzone.putTextRect(video, f'{classNames[name]} {confidence_value}', (max(0, x1), max(30, y1-18)),
                               scale=0.8, thickness=1, colorT=(0, 0, 0), colorR=(255, 255, 255))

    # Display the resulting frame
    cv2.imshow("Video Detector", video)
